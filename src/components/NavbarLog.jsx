...
const NavbarLog = () => {
    ...
    return (
        <div className={`w-full h-24 flex items-center justify-center  transition-colors duration-300 overflow-hidden
            ${isDarkmodeActive ? 'bg-gray-900' : 'bg-white'}`}>

            <div
                className='max-w-360 mx-auto px-88'
            >
                <div
                    className={`w-200 h-9 font-light flex items-center rounded-md text-lg transition-colors duration-300
                ...
                >
                    ...
                    >
                        <div
                            className={`pl-2 pr-10 flex items-center border-r-2 mr-6 transition-colors duration-300
